# open-pair — Real-time Collaborative Editing for VS Code + Neovim
...
2. In VS Code, open the Command Palette (`Ctrl+Shift+P`) and run **Open Pair: Join Session**
3. Paste the URL and enter your display name
4. Use **Open Pair: Open Workspace File** to browse the remote file tree
5. Use **Open Pair: Toggle Follow Mode** to follow the host's cursor
6. Use **Open Pair: Show Peers** to see who's connected
...
7. Run **Open Pair: Stop Session** to end the session
